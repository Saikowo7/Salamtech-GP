 ...
 * Use the [pill_detail_page_fragment.newInstance] factory method to
...
class pill_detail_page_fragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment pill_detail_page_fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            pill_detail_page_fragment().apply {
